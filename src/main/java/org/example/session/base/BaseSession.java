...
/**
 * <p>
 * BaseSession 封装了数据库连接和自动事务管理，保存点管理。
 * </p>
 * <p>
 * 子类需实现 {@link #self()} 方法，返回当前对象的引用，以支持链式调用。
 * </p>
 * <p>
 * 提供两种构造方法：
 * <ul>
 * <li>无参构造方法，使用默认数据源连接，用于支持自动事务</li>
 * <li>有参构造方法，传入数据库连接，用于支持手动事务，闭包事务</li>
 * </ul>
 * </p>
 * <p>
 * 提供了以下方法：
 * <ul>
 * <li>createSavepoint(String name)：创建保存点</li>
 * <li>rollbackToSavepoint(String name)：回滚到保存点</li>
 * <li>getNativeConnection()：获取底层数据库连接</li>
 * </ul>
 * </p>
 * <p>
 * @author duyujie
 * @version 1.0
 * @param <T> 如：public class SaveSession extends BaseSession<SaveSession>{}
 */
