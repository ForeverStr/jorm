...
/**
 * <p>
 * 继承自BaseSession，实现对数据库的删除操作
 * </p>
 * <p>
 * 提供两种模式的构造函数：
 * <ul>
 * <li>无参构造函数，用于创建新的数据库连接</li>
 * <li>有参构造函数，用于使用外部传入的数据库连接</li>
 * </ul>
 * </p>
 * <p>
 * 提供两种模式的删除操作：
 * <ul>
 * <li>单个实例对象删除：传入一个实例对象，根据主键值删除</li>
 * <li>批量实例对象删除：传入一个实例对象集合，根据主键值批量删除</li>
 * <li>类对象删除：传入一个类对象，根据条件删除</li>
 * </ul>
 * </p>
 * <p>
 * 所有操作均在事务中执行，事务提交失败时，会自动回滚。
 * </p>
 * @author duyujie
 * @version 1.0
 * @see BaseSession
